...
export default function ChatWidget() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
            {/* Simple Floating Button - No Text, No Ping, Just Icon */}
            <button
                onClick={handleWhatsAppClick}
                className="flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-xl transition-transform hover:scale-105 active:scale-95"
                title="Chat WhatsApp"
            >
