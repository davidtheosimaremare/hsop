...
export function CustomerCreateForm() {
    const [type, setType] = useState<"BISNIS" | "RETAIL">("BISNIS");
            ...
            <div className="space-y-4">
                {type === "BISNIS" && (
                    <div className="space-y-2">
                        ...
                        <Input id="company" name="company" placeholder="PT. Hokiindo Perkasa" required />
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <Input id="name" name="name" placeholder="Nama PIC atau Pelanggan" required />
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Input id="phone" name="phone" placeholder="812..." required className="flex-1" />
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Email ini akan digunakan untuk login nanti.</p>
                </div>
