    ...
    return (
        <div className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 p-3">
                ...
                {/* Price & Action */}
                <div className="flex-shrink-0 flex items-center gap-3 w-full sm:w-auto mt-3 sm:mt-0">
                    {priceInfo.isHidden ? (
                        <a
                            ...
                            className="w-full sm:w-auto h-9 px-4 rounded-xl flex items-center justify-center transition-all duration-300 shadow-xs hover:scale-[1.02] active:scale-95 bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white text-xs font-semibold gap-2 ml-auto"
                            title="Hubungi Kami"
