                    ...
                    <div className="flex items-center justify-between mb-2">
                        {priceInfo.isHidden ? (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full h-9 rounded-xl flex items-center justify-center transition-all duration-300 shadow-xs hover:scale-[1.02] active:scale-95 bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white text-xs font-semibold gap-2"
                                title="Hubungi Kami"
                                onClick={(e) => e.stopPropagation()}
                            >
